...
DROP DATABASE IF EXISTS `taxipos`;
...
INSERT INTO `calendar` (`id`, `unit_id`, `unit_maintenance_id`, `date_from`, `time_from`, `date_to`, `time_to`, `status`, `created_at`, `updated_at`, `deleted_at`) VALUES
	(1, 1, 1, '2015-08-11', '11:30:00', NULL, NULL, 0, '2015-08-10 06:07:34', '0000-00-00 00:00:00', '0000-00-00 00:00:00');
...
-- Dumping data for table taxipos.units_maintenance: ~0 rows (approximately)
...
INSERT INTO `units_maintenance` (`id`, `unit_id`, `maintenance_id`, `odometer`, `notes`, `status`, `prefered_date`, `prefered_time`, `created_at`, `created_by`, `updated_at`, `updated_by`, `deleted_at`, `deleted_by`) VALUES
	(1, 1, 1, 12000, 'test', 0, NULL, NULL, '2015-08-10 06:14:12', 1, NULL, NULL, NULL, NULL);
