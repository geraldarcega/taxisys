...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`taxisys` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci */;
...
CREATE TABLE `drivers` (
  ...
  KEY `unit_idFK` (`unit_idFK`,`on_duty`),
...
insert  into `drivers`(`driver_id`,`unit_idFK`,`fname`,`mname`,`lname`,`address`,`dob`,`sss`,`philhealth`,`pagibig`,`photo`,`on_duty`,`del`) values (1,2,'Jason','New','Bourne','Manila, Philippines','1990-01-30','13243546','13246345','24356342',NULL,1,'No'),(2,5,'Gerald','Sweet','Lover','Ph 1 Heritage Homes Marilao, Bulacan','1990-01-15','1234567823','65432453','2345675344',NULL,0,'No'),(3,5,'The','amazing','driver','This is only a test','1980-02-27','1234534','223423','244234234',NULL,1,'No');
...
insert  into `units`(`unit_id`,`garrage_idFK`,`plate_number`,`year_model`,`reg_rate`,`coding_rate`,`holiday_rate`,`sunday_rate`,`coding_day`,`resealing_date1`,`resealing_date2`,`franchise_until`,`renew_by`,`overhead_fund`,`docs_fund`,`replacement_fund`,`status`,`date_created`) values (1,NULL,'aaa 123',2015,123245,2312,2341,132,'Tuesday','2015-05-20','2015-05-20','2015-05-20','2015-05-20',123.00,234.00,3242.00,'On-duty','2015-05-30 23:38:00'),(2,NULL,'AAA 122',2014,1500,1000,1500,1300,'Friday','2014-01-01','2014-01-05','2018-01-01','2015-02-11',10000.00,3000.00,100000.00,'On-garrage','2015-06-04 17:16:32'),(3,NULL,'AAA 124',2014,1500,1000,1500,1300,'Monday','2015-05-13','2015-05-13','2015-05-28','2015-05-21',1000.00,100.00,100000.00,'On-garrage','2015-05-30 23:38:33'),(4,NULL,'AAA 3214',2015,1550,1200,1550,1400,'Monday','2015-05-03','2015-05-11','2020-01-01','2018-06-12',1200.00,100.00,2000.00,'On-garrage','2015-05-30 23:38:29'),(5,NULL,'ABX 1234',2006,1550,550,1350,1350,'Monday','2015-05-19','2016-01-01','2020-02-01','2020-01-01',120.00,120.00,300.00,'On-duty','2015-06-04 17:16:35');
