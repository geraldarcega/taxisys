...
class CI_DB_active_record extends CI_DB_driver {
	...
	/**
	 * Set where or like condition
	 *
	 * 
	 * @param	array() - seperated by "$1|$2" 
	 * $1 - wh => where / lk => like
	 * $2 - database field
	 * @return	void
	 */
	 ...
	 *
	 * 
	 * @param	array( sorting => array( fields ) )
	 * @return	void
	 */

	public function sort( $sort = null ) {
        if(is_array($sort)) {
            foreach($sort as $sorting => $flds) {
            	foreach ($flds as $fld) {
        			$this->order_by( $fld, $sorting );
            	}
            }
        }
	}
